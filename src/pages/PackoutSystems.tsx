      ...
      <section className="relative pt-32 pb-20 bg-gradient-to-br from-[#1e3046] to-[#2a4560]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <Package className="w-20 h-20 text-[#D4611C] mx-auto mb-6" />
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            {processSteps.map((step) => (
              <div key={step.step} className="bg-white rounded-xl p-8 shadow-sm flex items-start gap-6">
                <div className="w-16 h-16 bg-[#D4611C] rounded-xl flex items-center justify-center flex-shrink-0">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gradient-to-br from-[#D4611C] to-[#d65d1a] rounded-2xl p-12 text-white">
              ...
              <Link to="/consultation" className="inline-block px-8 py-4 bg-white text-[#D4611C] rounded-lg font-bold hover:bg-gray-100 transition-all">
