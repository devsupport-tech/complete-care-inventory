...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      {/* Content */}
      <div className="container mx-auto px-4 md:px-6 relative z-20 pt-36 pb-16">
        <div className={`max-w-3xl mx-auto mb-16 text-center transition-all duration-1000 delay-300 ${isLoaded ? 'opacity-100' : 'opacity-0 translate-y-12'}`}>
          ...
          <div className={`flex flex-col sm:flex-row gap-4 justify-center transition-all duration-1000 delay-700 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
            ...
            <a href="tel:+18326080535" className="bg-white hover:bg-gray-100 text-[#1e3046] font-medium px-8 py-4 rounded-md shadow-lg transition-all hover:shadow-xl hover:translate-y-[-2px] inline-flex items-center justify-center">
